...
class Api extends CI_Controller {
	...
	public function orderGedung(){
		...
		if(!$this->ketersediaanGedung($firstdate, $id_gedung)){
			...
			if($save){
				$message = $this->input->post('nama_pemesan', true).' melakukan order, silahkan cek pada aplikasi';
	...
	public function send_mail($emailto = array('mochakopiko@gmail.com'), $message = 'terdapat user yang memesan gedung', $email = 'percobaan.appscode@gmail.com', $password = 'lupaLagi') { 
