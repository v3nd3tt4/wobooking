            ...
            <div class="col-md-4">
                <div class="single-report">
                    <div class="s-report-inner pr--20 pt--30 mb-3">
                        ...
                        <div class="s-report-title d-flex justify-content-between">
                            <h4 class="header-title mb-0">Pemesanan</h4>
                            <!-- <p>24 H</p> -->
                        </div>
                        <div class="d-flex justify-content-between pb-2">
                            <h2><?=$data_pemesanan->row()->jml_pemesanan?></h2>
                            <!-- <span>- 45.87</span> -->
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="letest-news mt-5">
                        <div class="single-post mb-xs-40 mb-sm-40">
                            <div class="lts-thumb">
                                <img src="<?=base_url()?>assets_srtdash/images/blog/post-thumb1.jpg" alt="post thumb">
                            </div>
                        ...
                        <div class="single-post">
                            <div class="lts-thumb">
                                <img src="<?=base_url()?>assets_srtdash/images/blog/post-thumb2.jpg" alt="post thumb">
                            </div>
                            <div class="lts-content">
                                <span>Admin Post</span>
                                <h2><a href="blog.html">Sed ut perspiciatis unde omnis iste.</a></h2>
